...
const webpackConfig = {
  ...
  module: {
    ...
    rules: [{
      test: /(?:\.es6|\.es6\.js)$|(?:node_modules(?:\\|\/)bootstrap(?:\\|\/)js(?:\\|\/).+?\.js$)|(?:bootstrap-sweetalert(?:\/|\\)dev.+?\.js)$|(?:bootstrap-slider\.js)$|(?:popper\.js)$|(?:bootstrap-table(?:\\|\/).+?\.js$)|(?:shepherd\.js)|(?:fullcalendar\.js)|(?:sweetalert2\.js)/,
      use: [
        {
          loader: 'babel-loader',
          options: {
