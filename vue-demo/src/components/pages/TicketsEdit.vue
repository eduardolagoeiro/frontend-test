        ...
        <div class="row no-gutters">
          <div class="col-sm-6 col-md-8 col-lg-7 col-xl-8">
            ...
            <div class="media align-items-center mb-4">
              <img :src="`${publicUrl}img/avatars/${ticketData.author.avatar}`" alt="" class="d-block ui-w-50 rounded-circle">
        ...
        <div class="ui-bordered px-3 pt-3 mb-3">
          ...
          <div>
            <div v-for="(assignee, i) in ticketData.assignee" :key="assignee.avatar" class="ui-feed-icon-container d-inline-block mr-3 mb-3">
              ...
              <img :src="`${publicUrl}img/avatars/${assignee.avatar}`" v-b-tooltip.hover :title="assignee.name" class="ticket-assignee" alt="">
            </div>
        ...
        <div class="ui-bordered px-3 pt-3">
          ...
          <div class="clearfix">
            <div v-for="(file, i) in ticketData.attachments" :key="file.path" class="ui-feed-icon-container float-left pt-2 mr-3 mb-3">
              ...
              <a v-if="isImage(file)" :style="{'background-image': `url(${publicUrl}${file.path})`}" :href="publicUrl + file.path" target="_blank" class="ticket-file-img"></a>
