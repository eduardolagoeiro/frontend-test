  ...
  <div>
    ...
    <b-card no-body>
      <b-card-body class="media align-items-center">
        ...
        <img :src="`${publicUrl}img/avatars/${articleData.author.avatar}`" class="d-block ui-w-40 rounded-circle" alt="">
        <div class="media-body ml-3">
          <a href="javascript:void(0)" class="d-block text-body">
      ...
      <b-card-body class="pb-2">
        ...
        <div class="form-group media" style="min-height:1px">
          <div class="ui-bg-cover" style="width: 100px;height: 100px" :style="{'background-image': `url('${publicUrl}img/bg/${articleData.main_image}')`}"></div>
          <div class="media-body ml-3">
