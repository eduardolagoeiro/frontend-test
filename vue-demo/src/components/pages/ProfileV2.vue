    ...
    <div class="row">
      <div class="col-xl-4">
        ...
        <b-card no-body class="mb-4">
          <b-card-body>
            <div class="media">
              <img :src="`${publicUrl}img/avatars/5.png`" alt class="ui-w-60 rounded-circle">
              <div class="media-body pt-2 ml-3">
                ...
                <div class="mt-3">
                  <b-btn variant="primary rounded-pill" size="sm">+&nbsp; Follow</b-btn> &nbsp;
                  <b-btn variant="default icon-btn md-btn-flat rounded-pill" size="sm"><i class="ion ion-md-mail"></i></b-btn> &nbsp;
                </div>
              </div>
            </div>
          </b-card-body>
        ...
        <b-card class="mb-4" header="Links">
          <div class="media align-items-center pb-1 mb-3">
            <img :src="`${publicUrl}img/uikit/logo-5.png`" class="d-block ui-w-40 rounded-circle" alt>
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img :src="`${publicUrl}img/uikit/logo-6.png`" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img :src="`${publicUrl}img/uikit/logo-7.png`" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
          ...
          <div class="media align-items-center">
            <img :src="`${publicUrl}img/uikit/logo-8.png`" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body flex-truncate ml-3">
        ...
        <b-card class="mb-4" header="Friends">
          <div class="media align-items-center pb-1 mb-3">
            <img :src="`${publicUrl}img/avatars/2-small.png`" class="d-block ui-w-40 rounded-circle" alt>
          ...
          <div class="media align-items-center pb-1 mb-3">
            <img :src="`${publicUrl}img/avatars/3-small.png`" class="d-block ui-w-40 rounded-circle" alt>
            <div class="media-body ml-3">
