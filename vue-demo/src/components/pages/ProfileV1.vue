  ...
  <div>
    ...
    <div class="container-m-nx container-m-ny bg-white mb-4">
      <div class="media col-md-10 col-lg-8 col-xl-7 py-5 mx-auto">
        <img :src="`${publicUrl}img/avatars/5.png`" alt class="d-block ui-w-100 rounded-circle">
    ...
    <div class="row">
      <div class="col">
        ...
        <b-card class="mb-4">
          ...
          <div class="ui-bordered">
            <a href="javascript:void(0)" class="ui-rect ui-bg-cover text-white" :style="`background-image: url('${publicUrl}img/bg/1.jpg');`">
        ...
        <b-card class="mb-4">
          ...
          <a href="javascript:void(0)" class="ui-rect ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/6.jpg');`"></a>
        ...
        <b-card class="mb-4">
          ...
          <div class="border-top-0 border-right-0 border-bottom-0 ui-bordered pl-3 mt-4 mb-2">
            ...
            <a href="javascript:void(0)" class="ui-rect ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/8.jpg');`"></a>
          </div>
      ...
      <div class="col-xl-4">
        ...
        <b-card no-body class="mb-4">
          <b-card-body>
            <b-btn variant="primary rounded-pill">+&nbsp; Follow</b-btn> &nbsp;
            <b-btn variant="default icon-btn md-btn-flat rounded-pill"><i class="ion ion-md-mail"></i></b-btn>
          </b-card-body>
        ...
        <b-card class="mb-4" header="Skills">
          ...
          <div slot="footer">
            <a href="javascript:void(0)" class="d-block text-center text-body small font-weight-semibold">SHOW ALL SKILLS</a>
          </div>
        </b-card>
        <!-- / Skills -->
        ...
        <b-card no-body class="mb-4">
          ...
          <div class="row no-gutters row-bordered row-border-light">
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/2-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Leon Wilson</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/3-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Allie Rodriguez</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/4-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Kenneth Frazier</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/5-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Nellie Maxwell</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/6-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Mae Gibson</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/7-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Alice Hampton</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/11-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Belle Ross</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/12-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
              <div class="text-center small">Arthur Duncan</div>
            </a>
            <a href="javascript:void(0)" class="d-flex col-4 col-sm-3 col-md-4 flex-column align-items-center text-body py-3 px-2">
              <img :src="`${publicUrl}img/avatars/9-small.png`" alt class="d-block ui-w-40 rounded-circle mb-2">
        ...
        <b-card no-body class="card mb-4">
          ...
          <div class="row no-gutters align-items-start pt-1 pl-1">
            ...
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/1.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/2.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/3.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/4.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/5.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/6.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/7.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/8.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/9.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/10.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/11.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/12.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/13.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/14.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/15.jpg');`"></span>
            </a>
            <a href="javascript:void(0)" class="d-block col-3 col-sm-2 col-lg-3 pr-1 pb-1">
              <span class="d-block ui-square ui-bg-cover" :style="`background-image: url('${publicUrl}img/bg/16.jpg');`"></span>
            </a>
