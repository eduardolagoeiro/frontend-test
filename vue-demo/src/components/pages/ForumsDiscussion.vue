  ...
  <div>
    ...
    <b-card class="mb-4" footer-class="pt-0 px-0 pb-3">
      <div class="media flex-wrap align-items-center" slot="header">
        <img :src="`${publicUrl}img/avatars/${discussionData.author.avatar}`" class="d-block ui-w-40 rounded-circle" alt>
    ...
    <div v-for="reply in discussionData.replies" :key="reply.author.name + reply.date">
      <b-card class="mb-3">
        ...
        <div class="media">
          <img :src="`${publicUrl}img/avatars/${reply.author.avatar}`" alt class="d-block ui-w-40 rounded-circle">
