<template>
  <div>
    ...
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
      <div>Teams</div>
      <b-btn variant="primary rounded-pill" class="d-block"><span class="ion ion-md-add"></span>&nbsp; Add team</b-btn>
    </h4>
        ...
        <b-card no-body class="mb-4">
          <b-card-body class="pb-0">
            <div class="d-flex justify-content-between align-items-start">
              <div>
                <a href="javascript:void(0)" class="text-body text-big font-weight-semibold">{{team.title}}</a>
          ...
          <b-card-body class="pt-3 pb-0">
            ...
            <div class="d-flex flex-wrap">
              <a v-for="leader in team.leaders" :key="leader.avatar" href="javascript:void(0)" class="d-block mr-1 mb-1"><img :src="`${publicUrl}img/avatars/${leader.avatar}`" alt="" class="ui-w-30 rounded-circle"></a>
            </div>
          </b-card-body>
          <b-card-body class="py-3">
            <div class="text-muted small mb-2">Members</div>
            <div class="d-flex flex-wrap">
              <a v-for="member in team.members" :key="member.avatar" href="javascript:void(0)" class="d-block mr-1 mb-1"><img :src="`${publicUrl}img/avatars/${member.avatar}`" alt="" class="ui-w-30 rounded-circle"></a>
            </div>
          </b-card-body>
          <hr class="m-0">
          ...
          <b-card-body v-if="team.curProject">
            ...
            <div class="mb-3"><a href="javascript:void(0)" class="text-body font-weight-semibold">{{team.curProject.title}}</a></div>
