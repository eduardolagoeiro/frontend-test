            ...
            <tr v-for="client in clientsData" :key="client.name" :class="{'bg-light': selected === client && sideboxOpened}" @click="selectClient(client)">
              <td class="align-middle py-3">
                <div class="media align-items-center">
                  <img :src="`${publicUrl}img/avatars/${client.avatar}`" class="d-block ui-w-40 rounded-circle" alt="">
    ...
    <div class="clients-sidebox bg-body border-left">
      ...
      <perfect-scrollbar v-if="selected" :options="{ suppressScrollX: true, wheelPropagation: true }" class="clients-scroll container-p-y">
        ...
        <div class="text-center p-4">
          <img :src="`${publicUrl}img/avatars/${selected.avatar}`" class="ui-w-100 rounded-circle mb-4" alt="">
          <h5 class="mb-1"><a href="javascript:void(0)" class="text-body">{{selected.name}}</a></h5>
