<div class="ui-block">
    ...
    <div class="cui-example cui-example-vertical-spacing" data-blacklist="cui-utils-example-bg-color">
        <div class="cui-utils-example-bg-color">
            ...
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-light"><code>.bg-light</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-lighter"><code>.bg-lighter</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-lightest"><code>.bg-lightest</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="d-block col-sm bg-dark text-white"><code>.bg-dark</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-white"><code>.bg-white</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-transparent"><code>.bg-transparent</code></a>
            </div>
            <div class="row mx-0">
                <a href="javascript:void(0)" class="text-body d-block col-sm bg-body"><code>.bg-body</code></a>
            </div>
        </div>
    </div>
