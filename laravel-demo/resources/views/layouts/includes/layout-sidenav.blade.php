        ...
        <li class="sidenav-item{{ strpos($routeName, 'ui.') === 0 ? ' active open' : '' }}">
            ...
            <ul class="sidenav-menu">
                ...
                <li class="sidenav-item{{ $routeName == 'ui.tour' ? ' active' : '' }}">
                    <a href="{{ route('ui.tour') }}" class="sidenav-link"><div>Shepherd tour</div></a>
                </li>
                ...
                <li class="sidenav-item{{ $routeName == 'ui.spinners' ? ' active' : '' }}">
                    <a href="{{ route('ui.spinners') }}" class="sidenav-link"><div>Spinners</div></a>
                </li>
            </ul>
        </li>
        ...
        <li class="sidenav-item{{ strpos($routeName, 'misc.') === 0 ? ' active open' : '' }}">
            ...
            <ul class="sidenav-menu">
                <li class="sidenav-item{{ $routeName == 'misc.brand-colors' ? ' active' : '' }}">
                    <a href="{{ route('misc.brand-colors') }}" class="sidenav-link"><div>Brand colors</div></a>
                </li>
