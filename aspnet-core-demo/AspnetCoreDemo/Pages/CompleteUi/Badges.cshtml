<div class="ui-block">
    ...
    <div class="cui-example cui-example-inline-spacing">
        <button type="button" class="btn btn-default text-nowrap">Badge <span class="badge badge-primary indicator">12</span></button>
        <button type="button" class="btn btn-default text-nowrap">Outlined badge <span class="badge badge-outline-success indicator">12</span></button>
        <button type="button" class="btn btn-default text-nowrap">Pill <span class="badge badge-pill badge-info indicator">12</span></button>
        <button type="button" class="btn btn-default text-nowrap">Outlined pill <span class="badge badge-pill badge-outline-danger indicator">12</span></button>
        <button type="button" class="btn btn-default text-nowrap">Dot <span class="badge badge-dot badge-danger indicator"></span></button>
        <button type="button" class="btn btn-default text-nowrap">Outlined dot <span class="badge badge-dot badge-outline-success indicator"></span></button>
    </div>
</div>
