<div class="ui-block">
    ...
    <div class="cui-example">
        <div id="accordion">
            ...
            <div class="card mb-2">
                <div class="card-header">
                    <a class="collapsed text-body" data-toggle="collapse" href="#accordion-3">
    ...
    <div class="cui-example">
        <div id="accordion2">
            <div class="card mb-2">
                <div class="card-header">
                    <a class="text-body d-flex justify-content-between" data-toggle="collapse" aria-expanded="true" href="#accordion2-1">
                        Collapsible Group Item #1
            ...
            <div class="card mb-2">
                <div class="card-header">
                    <a class="collapsed text-body d-flex justify-content-between" data-toggle="collapse" href="#accordion2-3">
                        Collapsible Group Item #3
                        <div class="collapse-icon"></div>
                    </a>
                </div>
